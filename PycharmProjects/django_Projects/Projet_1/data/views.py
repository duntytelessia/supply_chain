...
def initialize(request):
    ...
    if not Goods.objects.all().exists():
        good_r1 = Goods(idG='R1', nameG='raw beef', durG=3)
        good_r1.save()
        good_r2 = Goods(idG='R2', nameG='raw pork', durG=3)
        good_r2.save()
        good_r3 = Goods(idG='R3', nameG='pepper', durG=5)
        good_r3.save()
        good_p4 = Goods(idG='R4', nameG='sauce', durG=5)
        good_p4.save()
        good_p1 = Goods(idG='P1', nameG='beef', durG=3)
        good_p1.save()
        good_p2 = Goods(idG='P2', nameG='pork', durG=3)
        good_p2.save()
        good_p3 = Goods(idG='P3', nameG='beed sauce', durG=5)
        good_p3.save()
        good_p4 = Goods(idG='P4', nameG='pork sauce', durG=5)
        good_p4.save()
